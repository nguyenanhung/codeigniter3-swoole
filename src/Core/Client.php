...
namespace nguyenanhung\CodeIgniter\Swoole\Core;
...
class Client
{
    ...
    public static function send(array $data)
    {
        ...
        // dynamic custom data
        $client->CodeIgniter3SwooleData = $data;
    ...
    {
        $post = serialize($client->CodeIgniter3SwooleData);
